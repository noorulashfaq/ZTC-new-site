...
const services = [
  {
    ...
    desc1: "Introduce new employees to company policies and procedures",
    subtitle2: "INTERNSHIPS",
    desc2: "Provide practical work and hands-on experience to students ",
    subtitle3: "DOMAIN TRAINING",
    desc3: "Offer specialized training and knowledge in industry domains",
  },
  {
    title: "IN-HOUSE",
    img: Inhouse,
    subtitle1: "COMPETITIVE TRAINING",
    desc1: "Provide training to stay competitive in the market",
    subtitle2: "BOOTCAMPS",
    desc2: "Intensive training programs designed for specific skill sets",
    subtitle3: "INTERNSHIPS",
    desc3: "Offer internship opportunities for practical experience",
  },
  {
    title: "CAMPUS",
    img: Campus,
    ...
    subtitle2: "WORKSHOPS",
    desc2: "Hands-on sessions focused on specific topics or skills",
    subtitle3: "BOOTCAMPS",
    desc3: "Intensive training programs designed to develop skills",
  },
  {
    title: "PROJECTS",
    img: ProofOfConcepts,
